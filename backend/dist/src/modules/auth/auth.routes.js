...
router.post('/refresh', (0, validate_middleware_1.validate)(auth_validator_1.refreshSchema), authController.refresh);
router.post('/logout', (0, validate_middleware_1.validate)(auth_validator_1.refreshSchema), authController.logout);
